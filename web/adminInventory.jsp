...
<%
    ...
    try{
        ...
        if(request.getParameter("editItemButton") != null){
            ...
            //TODO: need to check to make sure the barcode exists
                        ...
                        <div class="container">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4 md-form">
                                    ...
                                    <input type="text" id="newItemQuantity" name="newItemQuantity" class="form-control" pattern="[0-9]{1,}" required/>
                        ...
                        <div class="container">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4 md-form">
                                    ...
                                    <input type="text" id="itemQuantity" name="itemQuantity" class="form-control" pattern="[0-9]{1,}" required/>
                                    <div class="invalid-feedback">Invalid format, please enter a number </div>
                                </div>
                                <div class="form-group col-md-4 md-form">
