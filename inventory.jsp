...
<%
    ...
    try{
        ...
        if(request.getParameter("editItemButton") != null){
            //change archived from no to n
            ...
            String editItemQuery = "UPDATE inventory SET quantity = ?, price = ?, color = ?, product_name = ?, size = ?, clothing_type = ?, archived = ? WHERE barcode = "+ barcode;
            PreparedStatement editItem_stmt = connection.prepareStatement(editItemQuery);
            editItem_stmt.setInt(1, qty);
            editItem_stmt.setDouble(2, itemPrice);
            editItem_stmt.setString(3, request.getParameter("itemColor"));
            editItem_stmt.setString(4, request.getParameter("itemTitle"));
            editItem_stmt.setString(5, request.getParameter("itemSize"));
            editItem_stmt.setString(6, request.getParameter("itemType"));
            editItem_stmt.setString(7, request.getParameter("archiveValue"));
    ...
    <div class="container"><a class="navbar-brand logo" href="#">ThreadsExpress</a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="/mysqltest_war_exploded/inventory.jsp">Inventory</a></li>
...
<main class="page">
    ...
    <div class="modal fade" id="addNewLine" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <form class="needs-validation input-form" action="/mysqltest_war_exploded/inventory.jsp" method="post" novalidate>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="editmodalLabel">Edit Inventory Item</h4>
                    <button type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">X</span>
                    </button>
                </div>
                <form class="needs-validation input-form" action="/mysqltest_war_exploded/inventory.jsp" method="post" novalidate>
                    <div class="modal-body">
                        <div class="container">
                            <div class="form-row">
                                <div class="form-group col-md-5 md-form">
                                    <label class="form-label" for="barcode"><b>Barcode Number</b></label>
                                    <input type="text" id="barcode" name="barcode" class="form-control" pattern="[0-9]{8}" required/>
                                    <div class="invalid-feedback">Invalid barcode, please enter a valid 8-digit number</div>
                                </div>
                                <div class="form-group col-md-5 md-form">
                                    <label class="form-label" for="itemTitle"><b>Item Name</b></label>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4 md-form">
                                    <label class="form-label" for="itemQuantity"><b>Quantity</b></label>
                                    <input type="text" id="itemQuantity" name="itemQuantity" class="form-control" pattern="[0-9][0-9]" required/>
                                    <div class="invalid-feedback">Invalid format, please enter a number </div>
                                </div>
                                <div class="form-group col-md-4 md-form">
                                    <label class="form-label" for="itemPrice"><b>Item Price</b></label>
                                    <input type="text" id="itemPrice" name="itemPrice" class="form-control" pattern="[0-9]+(\.[0-9][0-9]?)?" required/>
                                    <div class="invalid-feedback">Invalid price, please enter in x.xx format.</div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-4 md-form">
                                    <label class="form-label" for="itemColor"><b>Item Color</b></label>
                                    <input type="text" id="itemColor" name="itemColor" class="form-control" pattern="[A-Za-z]{1,}" required/>
                                    <div class="invalid-feedback">Invalid Item Color</div>
                                </div>
                                <div class="form-group col-md-5 md-form">
                                    <label class="form-label" for="itemSize"><b>Item Size</b></label>
                                    <select class="form-control" id="itemSize" name="itemSize" data-width="100%">
                                        <option value="" selected disabled hidden>Size</option>
                                        <option value="onesize">Onesize</option>
                                        <option value="small">Small</option>
                                        <option value="medium">Medium</option>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-5 md-form">
                                    <label class="form-label" for="itemType"><b>Item Type</b></label>
                                    <select class="form-control" id="itemType" name="itemType" data-width="100%">
                                        <option value="" selected disabled hidden>Clothing Type</option>
                                        <option value="dresses">Dresses</option>
                                        <option value="hats">Hats</option>
                                        <option value="hoodies">Hoodies</option>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Exit</button>
                        <button type="submit" class="btn btn-primary" name="editItemButton">Edit Item</button>
                    </div>
                </form>
            </div>
